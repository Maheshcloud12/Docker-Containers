...
•	Docker is an open source platform for developing, shipping, and running applications inside lightweight & portable container. 
...
- Docker Client is the user-facing component that sends commands to the Docker Daemon using REST APIs.

- All container lifecycle operations are handled by the Docker Daemon.
